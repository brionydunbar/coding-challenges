...
def StockPicker(arr):
  min_price = float("inf") # track min price
  max_profit = 0 # track max profit
  # loop through each price
  for price in arr:
    if price < min_price:
      min_price = price # update min price
    current_profit = price - min_price # find current profit
...
# Testing
arr1 = [10,12,4,5,9] # 5
arr2 = [14,20,4,12,5,11] # 8
arr3 = [44, 30, 24, 32, 35, 30, 40, 38, 15] # 16

print(StockPicker(arr1))
print(StockPicker(arr2))
print(StockPicker(arr3))